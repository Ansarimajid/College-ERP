...
# Note: testing "update_attendance" in staff_views.py isn't possible because in urls.py,
# "staff_update_attendance" and "update_attendance" map to the same endpoint. So whenever
# that endpoint is hit, "staff_update_attendance" gets executed.
