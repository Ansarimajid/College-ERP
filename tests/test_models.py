...
class SessionModelTestCase(TestCase):
    def test_create_session(self):
        session = Session.objects.create(
            start_year=date(2023, 1, 1), end_year=date(2023, 12, 31)
        )
    ...
    def test_create_session_with_invalid_dates(self):
        with self.assertRaises(ValidationError):
            Session.objects.create(
                start_year=date(2023, 12, 31), end_year=date(2023, 1, 1)
            )
...
class CustomUserModelTestCase(TestCase):
    def setUp(self):
        ...
        self.session = Session.objects.create(
            start_year="2023-01-01", end_year="2023-12-31"
        )
    ...
    def setUp(self):
        ...
        self.student = Student.objects.create(
            admin=User.objects.create_user(
                email="student@test.com", password="testpass"
            )
        )
        self.book = Book.objects.create(
            name="Test Book",
...
class IssuedBookModelTestCase(TestCase):
    def test_issued_book_creation(self):
        ...
        self.assertEqual(
            issued_book.expiry_date.date(), datetime.today().date() + timedelta(days=14)
        )
...
class SubjectModelTestCase(TestCase):
    def setUp(self):
        ...
        self.staff = Staff.objects.create(
            admin=User.objects.create_user(email="staff@test.com", password="testpass")
        )
        self.subject = Subject.objects.create(
            name="Test Subject", staff=self.staff, course=self.course
        )
...
class AttendanceModelTestCase(TestCase):
    def setUp(self):
        ...
        self.attendance = Attendance.objects.create(
            session=self.session, subject=self.subject, date=timezone.now().date()
        )
...
class LeaveReportStudentModelTestCase(TestCase):
    def setUp(self):
        ...
        self.leave_report_student = LeaveReportStudent.objects.create(
            student=self.student, date="2023-06-10", message="Test Message"
        )
...
class LeaveReportStaffModelTestCase(TestCase):
    def setUp(self):
        ...
        self.leave_report_staff = LeaveReportStaff.objects.create(
            staff=self.staff, date="2023-06-10", message="Test Message"
        )
...
class FeedbackStudentModelTestCase(TestCase):
    def setUp(self):
        ...
        self.feedback_student = FeedbackStudent.objects.create(
            student=self.student, feedback="Test Feedback", reply="Test Reply"
        )
...
class FeedbackStaffModelTestCase(TestCase):
    def setUp(self):
        ...
        self.feedback_staff = FeedbackStaff.objects.create(
            staff=self.staff, feedback="Test Feedback", reply="Test Reply"
        )
...
class NotificationStaffModelTestCase(TestCase):
    def setUp(self):
        ...
        self.notification_staff = NotificationStaff.objects.create(
            staff=self.staff, message="Test Message"
        )
...
class NotificationStudentModelTestCase(TestCase):
    def setUp(self):
        ...
        self.notification_student = NotificationStudent.objects.create(
            student=self.student, message="Test Message"
        )
...
class StudentResultModelTestCase(TestCase):
    def setUp(self):
        ...
        self.student_result = StudentResult.objects.create(
            student=self.student, subject=self.subject, test=85.5, exam=92.0
        )
